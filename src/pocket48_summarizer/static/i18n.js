(() => {
  const dictionaries = {
    zh: {
      ...
      vocabularyAutoRebuild: "成员或术语变化后，单 Worker 会自动构建并启用 paraformer-v2 热词列表。",
    ...
    en: {
      ...
      vocabularyAutoRebuild: "After members or terms change, the single worker automatically builds and activates a paraformer-v2 vocabulary.",
