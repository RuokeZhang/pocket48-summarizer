(() => {
  const dictionaries = {
    zh: {
      ...
      clipTimeline: "精细时间线",
      clipTimelineHint: "移动红线预览，单击后暗玫红线保留标记；拖动边界靠近标记线会优先吸附",
    ...
    en: {
      ...
      clipTimelineHint: "Move the red line to preview; click to leave a dark rose marker that nearby boundaries snap to first",
