(() => {
  const dictionaries = {
    zh: {
      ...
      clipTimeline: "精细时间线",
      clipTimelineHint: "拖动边界；靠近语句时会吸附，松手后再检查静音",
      clipZoomOut: "缩小时间线",
      clipZoomIn: "放大时间线",
    ...
    en: {
      ...
      clipTimelineHint: "Drag a boundary to snap locally; silence is checked only after release",
      ...
      clipTimeInvalid: "Enter a valid time in HH:MM:SS.s format.",
      ...
      snapManual: "Manual position",
      snapSentence: "Snapped to sentence",
      snapSilence: "Snapped to nearby silence",
      snapChecking: "Checking nearby silence…",
