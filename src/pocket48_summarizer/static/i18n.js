(() => {
  const dictionaries = {
    zh: {
      ...
      clipTimeline: "精细时间线",
      clipTimelineHint: "移动红线预览，单击留下标记；可在标记处分割，拖动边界靠近标记线会优先吸附",
      timelineLyricPreview: "时间轴字幕预览",
      timelineLyricDisabled: "字幕已关闭",
      timelineLyricUnavailable: "这个位置附近没有字幕",
      clipZoomOut: "缩小时间线",
      clipZoomIn: "放大时间线",
      clipKeyboardHint: "聚焦边界后用 ←/→ 微调 0.1 秒，按住 Shift 调整 1 秒。",
      manualCutEditing: "手动删减片段",
      manualCutEditingHint: "先单击时间轴留下标记，再分割并删除不需要的片段；导出时会按原顺序自动拼接。",
      splitAtMarker: "在标记处分割",
      deleteSelectedSegment: "删除选中片段",
      restoreSelectedSegment: "恢复选中片段",
      clipSegments: "剪辑片段",
      clipCutSummary: "成片 {duration} · 保留 {kept} 段 · 删除 {deleted} 段",
      ...
      customCover: "自定义封面",
      customCoverHint: "选择视频画面并添加两行以内的标题",
      enableCustomCover: "启用封面",
      useCurrentCoverFrame: "使用当前画面",
      previewCover: "预览封面",
      returnClipPreview: "返回剪辑预览",
      coverPreview: "封面预览",
      coverTitleText: "封面标题",
      coverTitlePlaceholder: "输入封面标题",
      coverTitleStyle: "标题样式",
      coverStyleScrim: "暗幕粗体",
      coverStyleScrimHint: "最稳定，适合复杂画面",
      coverStyleDisplay: "高亮描边",
      coverStyleDisplayHint: "更醒目，适合短标题",
      coverStyleBadge: "玫红标题条",
      coverStyleBadgeHint: "对比最强，画面再亮也清楚",
      coverDurationHint: "封面会以 1.5 秒静帧放在视频开头，原视频声音随后开始。",
      coverTitleRequired: "请输入封面标题。",
      coverFrameRequired: "请在所选剪辑范围内重新选择封面画面。",
      coverFrameRemovedByCut: "封面画面位于已删除片段，请重新选择封面画面。",
      cancel: "取消",
    ...
    en: {
      ...
      clipTimelineHint: "Move the red line to preview, click to leave a marker, split there, or snap a nearby boundary to it",
      ...
      clipKeyboardHint: "Focus a boundary and press ←/→ for 0.1 seconds, or hold Shift for 1 second.",
      manualCutEditing: "Manual cut removal",
      manualCutEditingHint: "Click the timeline to leave a marker, split there, then remove unwanted segments. Export joins the kept segments in their original order.",
      ...
      clipCutSummary: "Output {duration} · {kept} kept · {deleted} deleted",
      ...
      customCoverHint: "Choose a video frame and add a title of up to two lines",
      enableCustomCover: "Enable cover",
      useCurrentCoverFrame: "Use current frame",
      previewCover: "Preview cover",
      returnClipPreview: "Return to clip preview",
      coverPreview: "Cover preview",
      coverTitleText: "Cover title",
      coverTitlePlaceholder: "Enter a cover title",
      coverTitleStyle: "Title style",
      coverStyleScrim: "Bold scrim",
      coverStyleScrimHint: "Most reliable on detailed frames",
      coverStyleDisplay: "Highlight outline",
      coverStyleDisplayHint: "More expressive for short titles",
      coverStyleBadge: "Rose title bar",
      coverStyleBadgeHint: "Strongest contrast on bright frames",
      coverDurationHint: "A 1.5-second still cover is placed first; the original audio starts afterward.",
      coverTitleRequired: "Enter a cover title.",
      coverFrameRequired: "Choose a cover frame inside the selected clip range.",
      coverFrameRemovedByCut: "The cover frame was inside a deleted segment. Choose a new cover frame.",
      cancel: "Cancel",
