(() => {
  const dictionaries = {
    zh: {
      ...
      clipTimeline: "精细时间线",
      clipTimelineHint: "移动红线预览，单击锁定时间；拖动边界靠近红线会优先吸附",
      clipMarkerLabel: "标记 {time}",
    ...
    en: {
      ...
      clipTimelineHint: "Move the red line to preview, click to pin; nearby boundaries snap to it first",
      clipMarkerLabel: "Mark {time}",
