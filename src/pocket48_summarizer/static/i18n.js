(() => {
  const dictionaries = {
    zh: {
      ...
      aiCoverHint: "用 MARK 截图生成 16:9 与 4:3 横屏背景，再免费切换三种中文短视频排版；所有可见文字都可编辑。",
      ...
      aiCoverLayoutStyle: "排版模板",
      aiCoverStyleSticker: "A · 贴纸高亮",
      aiCoverStyleStickerHint: "关键词撞色、双层描边",
      aiCoverStyleEditorial: "B · 轻弧杂志",
      aiCoverStyleEditorialHint: "清透留白、轻微弧度",
      aiCoverStyleBanner: "C · 贴条叠画面",
      aiCoverStyleBannerHint: "标题压画面、节奏更强",
      aiCoverMainText: "主标题",
      aiCoverHighlightText: "重点文字",
      aiCoverExtraText: "补充文字 {index}",
      aiCoverAddText: "添加补充文字",
      aiCoverGenerate: "一键生成双尺寸",
      aiCoverUpdateText: "更新排版与文字",
      aiCoverRegenerate: "换一版",
      aiCoverRetry: "重试失败任务",
    ...
    en: {
      ...
      aiCoverHint: "Generate 16:9 and 4:3 backgrounds from a marked frame, then switch among three local Chinese short-video layouts for free. Every visible text line is editable.",
      ...
      aiCoverLayoutStyle: "Layout template",
      aiCoverStyleSticker: "A · Sticker highlight",
      aiCoverStyleStickerHint: "Keyword contrast and double outlines",
      aiCoverStyleEditorial: "B · Editorial arc",
      aiCoverStyleEditorialHint: "Clean space with a slight arc",
      aiCoverStyleBanner: "C · Layered banners",
      aiCoverStyleBannerHint: "Headline overlaps the image",
      aiCoverMainText: "Main title",
      aiCoverHighlightText: "Highlighted text",
      aiCoverExtraText: "Supporting text {index}",
      aiCoverAddText: "Add supporting text",
      aiCoverGenerate: "Generate both sizes",
      aiCoverUpdateText: "Update layout and text",
      aiCoverRegenerate: "Generate another version",
